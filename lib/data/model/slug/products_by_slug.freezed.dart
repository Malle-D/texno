...
ProductsBySlug _$ProductsBySlugFromJson(Map<String, dynamic> json) {
  return _ProductsBySlug.fromJson(json);
}

/// @nodoc
mixin _$ProductsBySlug {
  ...
  @JsonKey(ignore: true)
  $ProductsBySlugCopyWith<ProductsBySlug> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ProductsBySlugCopyWith<$Res> {
  factory $ProductsBySlugCopyWith(
          ProductsBySlug value, $Res Function(ProductsBySlug) then) =
      _$ProductsBySlugCopyWithImpl<$Res, ProductsBySlug>;
  @useResult
...
/// @nodoc
class _$ProductsBySlugCopyWithImpl<$Res, $Val extends ProductsBySlug>
    implements $ProductsBySlugCopyWith<$Res> {
  _$ProductsBySlugCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ProductsBySlugImplCopyWith<$Res>
    implements $ProductsBySlugCopyWith<$Res> {
  factory _$$ProductsBySlugImplCopyWith(_$ProductsBySlugImpl value,
          $Res Function(_$ProductsBySlugImpl) then) =
      __$$ProductsBySlugImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({bool? success, String? message, int? code, ProductItems? data});
...
/// @nodoc
class __$$ProductsBySlugImplCopyWithImpl<$Res>
    extends _$ProductsBySlugCopyWithImpl<$Res, _$ProductsBySlugImpl>
    implements _$$ProductsBySlugImplCopyWith<$Res> {
  __$$ProductsBySlugImplCopyWithImpl(
      _$ProductsBySlugImpl _value, $Res Function(_$ProductsBySlugImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ProductsBySlugImpl(
      freezed == success
          ? _value.success
          : success // ignore: cast_nullable_to_non_nullable
              as bool?,
...
class _$ProductsBySlugImpl implements _ProductsBySlug {
  const _$ProductsBySlugImpl(this.success, this.message, this.code, this.data);

  factory _$ProductsBySlugImpl.fromJson(Map<String, dynamic> json) =>
      _$$ProductsBySlugImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ProductsBySlug(success: $success, message: $message, code: $code, data: $data)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ProductsBySlugImplCopyWith<_$ProductsBySlugImpl> get copyWith =>
      __$$ProductsBySlugImplCopyWithImpl<_$ProductsBySlugImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ProductsBySlugImplToJson(
      this,
    );
  }
}

abstract class _ProductsBySlug implements ProductsBySlug {
  const factory _ProductsBySlug(final bool? success, final String? message,
      final int? code, final ProductItems? data) = _$ProductsBySlugImpl;

  factory _ProductsBySlug.fromJson(Map<String, dynamic> json) =
      _$ProductsBySlugImpl.fromJson;
